...
export const mangaStore = defineStore("manga", {
  ...
  actions: {
    async getManga(page) {
      try {
        const response = await fetch(
          `https://manga-api-topaz.vercel.app/manga_list/?length=${page}`
        );
    ...
    async getMangaPopular(page) {
      try {
        const response = await fetch(
          `https://manga-api-topaz.vercel.app/manga_popular/?length=${page}`
        );
    ...
    async getMangaUpdate() {
      try {
        const response = await fetch(
          `https://manga-api-topaz.vercel.app/manga_update`
        );
    ...
    async getMangaInfo(id) {
      ...
      try {
        this.mangaInfo = [];
        const response = await fetch(
          `https://manga-api-topaz.vercel.app/manga_info/${id}`
        );
    ...
    async getMangaSearch(search) {
      ...
      try {
        const response = await fetch(
          `https://manga-api-topaz.vercel.app/manga_search?find=${search}`
        );
    ...
    async getMangaChapter(chapterUrl) {
      try {
        const response = await fetch(
          `https://manga-api-topaz.vercel.app/read_manga?chapterUrl=${chapterUrl}`,
          {}
        );
