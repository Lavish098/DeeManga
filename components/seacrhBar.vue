<template>
  <div>
    ...
    <div class="absolute left-[350px] z-10 mt-2 w-[450px] origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" v-if="search">
